...
export const FAMILIES={
  ...
  horde:{chaserSprite:[5],swarmSprite:[3.5],spitSprite:[5],tankSprite:[9],bombSprite:[4.5],ghostSprite:[5,1,0,'crystal maze wraith, drawn at 70% alpha'],huntMarkSprite:[0,1,0,'at y-r-12'],eliteMarkSprite:[0,1,0,'at y-r-8']},
