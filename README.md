...
Single-file, no-assets canvas game — couch co-op survival for 1–4 gamepads (keyboard plays as one more pad). Open in Chrome/Edge and press **A** on a pad, or use the keyboard.
